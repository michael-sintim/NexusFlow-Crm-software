        ...
        <div className="space-y-4">
            ...
            <div className="bg-red-50 dark:bg-red-900/20 border border-red-200 dark:border-red-800 rounded-lg p-4">
              <div className="flex items-center justify-between">
                <div className="flex items-center">
                  <span className="text-red-800 dark:text-red-400 text-sm">{filterError}</span>
                </div>
                <button 
                  onClick={() => setFilterError('')}
                  className="text-red-800 dark:text-red-400 hover:text-red-600"
                >
                  <X className="h-4 w-4" />
                </button>
              </div>
          ...
          {hasActiveFilters && !filterError && !hasFilterResults && (
            <div className="flex flex-wrap gap-2">
              {filters.status && (
                <div className="flex items-center gap-1 bg-blue-100 dark:bg-blue-900/30 px-3 py-1 rounded-full text-sm">
          ...
          {/* Filters Panel */}
          {showFilters && (
            <div className="bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-lg p-6 space-y-6 shadow-lg">
