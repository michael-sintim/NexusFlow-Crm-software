...
class CalendarEvent(models.Model):
    ...
    # Relationships
    customer = models.ForeignKey(Contact, on_delete=models.CASCADE, null=True, blank=True, related_name='calendar_events')
    opportunity = models.ForeignKey(Opportunity, on_delete=models.CASCADE, null=True, blank=True, related_name='calendar_events')
